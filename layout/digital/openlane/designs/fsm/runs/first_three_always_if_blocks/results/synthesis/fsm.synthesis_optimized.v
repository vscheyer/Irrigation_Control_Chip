module fsm (clk,
 ...
 sky130_fd_sc_hd__inv_2 _11_ (.A(net4),
    .Y(_03_));
 sky130_fd_sc_hd__inv_2 _12_ (.A(\state[1] ),
    .Y(_04_));
 sky130_fd_sc_hd__or4b_4 _13_ (.A(\state[1] ),
    .B(\state[0] ),
    .C(net3),
    .D_N(net2),
    .X(_05_));
 sky130_fd_sc_hd__or2b_1 _14_ (.A(\state[0] ),
    .B_N(_05_),
    .X(_06_));
 sky130_fd_sc_hd__inv_2 _15_ (.A(_06_),
    .Y(_07_));
 sky130_fd_sc_hd__o211a_1 _16_ (.A1(_03_),
    .A2(net6),
    .B1(_04_),
    .C1(_07_),
    .X(_08_));
 sky130_fd_sc_hd__nor2_4 _17_ (.A(_03_),
    .B(net5),
    .Y(_09_));
 sky130_fd_sc_hd__nor3_4 _18_ (.A(\state[1] ),
    .B(_09_),
    .C(_07_),
    .Y(_10_));
 sky130_fd_sc_hd__or3_1 _19_ (.A(\state[1] ),
    .B(_08_),
    .C(_10_),
    .X(_01_));
 sky130_fd_sc_hd__o21a_1 _20_ (.A1(\state[1] ),
    .A2(_09_),
    .B1(_06_),
    .X(_00_));
 sky130_fd_sc_hd__a211o_1 _21_ (.A1(net9),
    .A2(_05_),
    .B1(_08_),
    .C1(_10_),
    .X(_02_));
 sky130_fd_sc_hd__dfxtp_1 _22_ (.D(_00_),
    .Q(\state[0] ),
    .CLK(clk));
 sky130_fd_sc_hd__dfxtp_2 _23_ (.D(_01_),
    .Q(\state[1] ),
    .CLK(clk));
 ...
 sky130_fd_sc_hd__clkbuf_1 input3 (.A(l_thresh[1]),
    .X(net3));
 sky130_fd_sc_hd__clkbuf_1 input4 (.A(m_sense),
    .X(net4));
